...
const sumbitButton: HTMLButtonElement = <HTMLButtonElement>document.querySelector("form#authForm > button[type=submit]")!;
const updatePasswordButton: HTMLButtonElement = <HTMLButtonElement>document.querySelector(`form#editPassword > button.btn[type="submit"]`)!;
